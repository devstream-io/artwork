...
In this repo, we have artwork in standard formats for the CNCF [projects](https://www.cncf.io/projects/) and programs. We prepare artwork with these characteristics:
| Formats  | Layouts | Versions|
| ------------- | ------------- | ------------- |
| PNG  | Horizontal (landscape)  | Color |
| SVG  | Stacked (close to square)  | Black|
|   | Icon (no name and is square)  | White|

By choosing one of each column at a time, that's at least 18 versions of most logos.
